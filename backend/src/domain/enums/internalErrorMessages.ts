export enum INTERNAL_ERROR_MESSAGES {
  ...
  NOT_AUTHORIZED_TO_REVIEW_RIDE = "notAuthorizedToReviewRide",
  RIDE_MUST_BE_COMPLETED = "rideMustBeCompleted",
  RIDE_PAYMENT_MUST_BE_COMPLETED = "ridePaymentMustBeCompleted",
  ALREADY_REVIEWED_RIDE = "alreadyReviewedRide",
  NO_DRIVER_ASSIGNED = "noDriverAssigned",
  DRIVER_CAB_NOT_FOUND = "driverCabNotFound",
  NOT_AUTHORIZED_TO_REVIEW_BOOKING = "notAuthorizedToReviewBooking",
