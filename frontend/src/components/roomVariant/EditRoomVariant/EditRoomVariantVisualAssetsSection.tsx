...
interface EditRoomVariantVisualAssetsSectionProps {
...
function EditRoomVariantVisualAssetsSection({
    existingCoverImage,
...
}: EditRoomVariantVisualAssetsSectionProps) {
...
export default EditRoomVariantVisualAssetsSection;
