...
interface RoomVariantVisualAssetsSectionProps {
...
function RoomVariantVisualAssetsSection({
    coverImage,
    galleryImages,
    onCoverImageChange,
    onGalleryImagesAdd,
    onGalleryImageRemove,
}: RoomVariantVisualAssetsSectionProps) {
...
export default RoomVariantVisualAssetsSection;
