...
export const createRoomVariantValidationSchema = () => {
    return z.object({
        name: z
            .string()
...
export type RoomVariantFormValues = z.infer<
    ReturnType<typeof createRoomVariantValidationSchema>
>;

export type RoomVariantFormType = UseFormReturn<RoomVariantFormValues>;
