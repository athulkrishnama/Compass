...
import BasicRoomInfoSection from "./BasicRoomInfoSection";
import OccupancyBeddingSection from "./OccupancyBeddingSection";
import PricingStatusSection from "./PricingStatusSection";
import AmenitiesPoliciesSection from "./AmenitiesPoliciesSection";
import RoomVisualAssetsSection from "./RoomVisualAssetsSection";

const routeApi = getRouteApi("/hotel/hotels/$hotelId_/rooms/add");
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex flex-col">
                                    <h1 className="font-bold text-gray-900 text-sm sm:text-base">
                                        {t(translationKey.headings.addNewRoom)}
                                    </h1>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                >
                                    ...
                                    {isPending
                                        ...
                                        : t(translationKey.button.saveRoom)}
                                </Button>
                            </div>
                        </div>
                    </div>
